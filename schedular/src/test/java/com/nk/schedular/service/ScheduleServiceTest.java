...
class ScheduleServiceTest {
        ...
        void testUpdateSchedule_ScheduleNotFound() {
                ...
                // Run the test
                assertThatThrownBy(() -> scheduleServiceUnderTest.updateSchedule(updateScheduleRequest))
        ...
        void testGetAllSchedules() {
                ...
                // Run the test
                final ScheduleDTOList result = scheduleServiceUnderTest.getAllSchedules(ApiConstants.DEFAULT_PAGE,
        ...
        void testGetAllSchedulesByCronSchedule() {
                ...
                // Run the test
                final ScheduleDTOList result = scheduleServiceUnderTest.getAllSchedulesByCronSchedule(
        ...
        void testGetAllSchedulesByCronSchedule_ScheduleRepoReturnsNoItems() {
                ...
                // Run the test
                final ScheduleDTOList result = scheduleServiceUnderTest.getAllSchedulesByCronSchedule(null, null,
                                SortOrder.ASC,
                                ScheduleShortBy.SCHEDULE_ID, "cronSchedule");
        ...
        void testGetAllSchedulesByCronSchedule_3() {
                ...
                // Run the test
                assertThatThrownBy(
                                () -> scheduleServiceUnderTest.getAllSchedulesByCronSchedule(null, null, SortOrder.ASC,
                                                ScheduleShortBy.SCHEDULE_ID, "cronSchedule"))
                                .isInstanceOf(InternalServerException.class);
        }
        ...
        void testFindOrCreateSchedule_ExistingScheduleFound() {
                // Setup
                ScheduleRequest scheduleRequest = ScheduleRequest.builder().scheduleId("existingScheduleId")
        ...
        void testFindOrCreateSchedule_NewScheduleCreated() {
                // Setup
                ScheduleRequest scheduleRequest = ScheduleRequest.builder().scheduleId("newScheduleId")
                                .cronSchedule("0/10 * * ? * *").build();
        ...
        @Test
        void testGetDistinctCronExpression_ReturnsEmptyList() {
                // Arrange
                List<String> expectedResult = Collections.emptyList();
                when(mockScheduleRepo.getDistinctCronExpression()).thenReturn(expectedResult);

                // Act
                List<String> result = scheduleServiceUnderTest.getDistinctCronExpression();
        ...
        @Test
        void testGetDistinctCronExpression_ReturnsNonEmptyList() {
                // Arrange
                List<String> expectedResult = List.of("cron1", "cron2");
                when(mockScheduleRepo.getDistinctCronExpression()).thenReturn(expectedResult);
