...
class TaskServiceTest {
    ...
    void testSaveTask() {
        // Setup
        final TaskRequest task = TaskRequest.builder()
                .id(0L)
                .taskId("taskId")
    ...
    void testSaveTask_TaskIdAlreadyExists() {
        ...
        // Run the test
        assertThatThrownBy(() -> taskServiceUnderTest.saveTask(task)).isInstanceOf(DuplicateTransactionException.class);
    }
    ...
    void testGetTask_TaskRepoReturnsAbsent() {
        ...
        // Run the test
        assertThatThrownBy(() -> taskServiceUnderTest.getTask("taskId")).isInstanceOf(BadRequestException.class);
    }
    ...
    void testUpdateTask() {
        ...
        // Run the test
        final TaskDTO result = taskServiceUnderTest.updateTask(task);
    ...
    void testUpdateTask_Task_ID_NOT_FOUND() {
        ...
        // Run the test
        assertThatThrownBy(() -> taskServiceUnderTest.updateTask(task)).isInstanceOf(NotFoundException.class).hasMessage(ApiConstants.INVALID_TASK_ID + " " + task.getId());
    }
    ...
    void testGetTaskByTaskIds() {
        // Setup
        final TaskList expectedResult = TaskList.builder()
        ...
        final Page<DemoTask> demoTasks = new PageImpl<>(List.of(DemoTask.builder()
                ...
                .lastUpdatedAt(LocalDateTime.of(2020, 1, 1, 0, 0, 0))
                .build()));
        when(mockTaskRepo.findAllTaskWithTaskIds(any(Pageable.class), eq(List.of("value")))).thenReturn(demoTasks);
        ...
        // Run the test
        final TaskList result = taskServiceUnderTest.getTaskByTaskIds(List.of("value"), ApiConstants.DEFAULT_PAGE, ApiConstants.DEFAULT_PAGE_SIZE, SortOrder.ASC,
                TaskShortBy.NAME);
    ...
    void testGetTaskByTaskIds_pageIsNull() {
        ...
        // Run the test
        final TaskList result = taskServiceUnderTest.getTaskByTaskIds(List.of("value"), null, ApiConstants.DEFAULT_PAGE_SIZE, SortOrder.ASC,
                TaskShortBy.NAME);
    ...
    void testGetTaskByTaskIds_pageSizeIsNull() {
        ...
        // Run the test
        final TaskList result = taskServiceUnderTest.getTaskByTaskIds(List.of("value"), ApiConstants.DEFAULT_PAGE, null, SortOrder.ASC,
                TaskShortBy.NAME);
    ...
    void testGetTaskByTaskIds_TaskRepoReturnsNoItems() {
        ...
        // Run the test
        final TaskList result = taskServiceUnderTest.getTaskByTaskIds(List.of("value"), null, null, SortOrder.NONE,
                TaskShortBy.NONE);
    ...
    void testGetTaskByTaskIds_PageIsInvalid() {
        ...
        // Run the test
        assertThatThrownBy(() -> taskServiceUnderTest.getTaskByTaskIds(taskIds, 2, ApiConstants.DEFAULT_PAGE_SIZE, SortOrder.DESC,
        TaskShortBy.NAME)).isInstanceOf(BadRequestException.class);
    ...
    void testGetTaskByTaskIds_findAllTaskWithTaskIds_ReturnsNull() {
        ...
        // Run the test
        assertThatThrownBy(() -> taskServiceUnderTest.getTaskByTaskIds(taskIds, 2, ApiConstants.DEFAULT_PAGE_SIZE, SortOrder.ASC,
    ...
    void testGetAllTask() {
        ...
        // Run the test
        final TaskList result = taskServiceUnderTest.getAllTask(ApiConstants.DEFAULT_PAGE, ApiConstants.DEFAULT_PAGE_SIZE, SortOrder.ASC, TaskShortBy.NAME);
    ...
    void testGetAllTask_findAll_ReturnsNull() {
        ...
        // Run the test
        assertThatThrownBy(() -> taskServiceUnderTest.getAllTask( 2, ApiConstants.DEFAULT_PAGE_SIZE, SortOrder.ASC,
        TaskShortBy.NAME)).isInstanceOf(InternalServerException.class);
    }
    ...
    void testGetAllTaskBySchedule() {
        ...
        // Run the test
        final TaskList result = taskServiceUnderTest.getAllTaskBySchedule(1, null, SortOrder.ASC, TaskShortBy.NAME,
                "scheduleId");
    ...
    void testGetAllTaskBySchedule_findAll_ReturnsNull() {
        ...
        // Run the test
        assertThatThrownBy(() -> taskServiceUnderTest.getAllTaskBySchedule( 2, ApiConstants.DEFAULT_PAGE_SIZE, SortOrder.ASC,
    ...
    void testGetAllTaskBySchedule_ShortOrderIsNull() {
        ...
        // Run the test
        assertThatThrownBy(() -> taskServiceUnderTest.getAllTaskBySchedule( 2, ApiConstants.DEFAULT_PAGE_SIZE, null,
        TaskShortBy.NAME,"scheduleId")).isInstanceOf(BadRequestException.class);
    }
    ...
    void testGetAllTaskByCronExp() {
        ...
        // Run the test
        final TaskList result = taskServiceUnderTest.getAllTaskByCronExp(ApiConstants.DEFAULT_PAGE, ApiConstants.DEFAULT_PAGE_SIZE, SortOrder.ASC, TaskShortBy.NAME,
                "cronSchedule");
    ...
    void testGetAllTaskByCronExp_findAllWithCron_ReturnsNull() {
        ...
        // Run the test
        assertThatThrownBy(() -> taskServiceUnderTest.getAllTaskByCronExp( 2, ApiConstants.DEFAULT_PAGE_SIZE, SortOrder.ASC,
    ...
    void testGetAllTaskByCronExp_ShortOrderIsNull() {
        ...
        // Run the test
        assertThatThrownBy(() -> taskServiceUnderTest.getAllTaskByCronExp( 2, ApiConstants.DEFAULT_PAGE_SIZE, null,
        TaskShortBy.NAME,"cronSchedule")).isInstanceOf(BadRequestException.class);
    }
